...
Un centroid al unui arbore este un nod care, dacă îl eliminăm, toți subarborii rezultați au cel mult jumătate din nodurile arborelui original. Pentru a descompune intreg arborele, găsim un centroid, îl eliminăm, și apoi aplicăm recursiv aceeași procedură pe fiecare subarbore rezultat. Complexitatea acestei descompuneri este $O(N log N)$, deoarece fiecare nod este procesat de cel mult $O(log N)$ ori.
