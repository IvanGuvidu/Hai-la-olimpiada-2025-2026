...
Algoritmii de complexitate exponențială, de obicei, au la bază generarea de submulțimi. Ca exemplu, aveți funcția din sursa `expo.cpp` atașată mai jos:
...
Algoritmii de complexitate factorială au la bază generarea de permutări. O implementare aveți în funcția `factorial.cpp`, pe care o găsiți mai jos:
